...
set(ADA_LOVELACE "89")
# Blackwell (CUDA >= 12)
set(BLACKWELL "90 100 120")
if (UNIX AND NOT APPLE)
  set(Caffe_known_gpu_archs "${PASCAL} ${VOLTA} ${TURING} ${AMPERE} ${ADA_LOVELACE} ${BLACKWELL}")
elseif (WIN32)
  set(Caffe_known_gpu_archs "${PASCAL} ${VOLTA} ${TURING} ${AMPERE} ${ADA_LOVELACE} ${BLACKWELL}")
endif ()
...
function(caffe_select_nvcc_arch_flags out_variable)
  # List of arch names
  set(__archs_names "Pascal (CUDA >= 8)" "Volta (CUDA >= 9)" "Turing (CUDA >= 10)" "Ampere (CUDA > 11)" "Ada Lovelace (CUDA >= 11.8)" "Blackwell (CUDA >= 12)" "All" "Manual")
  ...
  if (${CUDA_ARCH} STREQUAL "Pascal (CUDA >= 8)")
  ...
  elseif (${CUDA_ARCH} STREQUAL "Ada Lovelace (CUDA >= 11.8)")
    set(__cuda_arch_bin ${ADA_LOVELACE})
  elseif (${CUDA_ARCH} STREQUAL "Blackwell (CUDA >= 12)")
    set(__cuda_arch_bin ${BLACKWELL})
